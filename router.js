...
router.get('/bit/job', require('./routes/universities/bit/job'));
...
// 北京交通大学
router.get('/bjtu/job', require('./routes/universities/bjtu/job'));
...
// 清华大学
router.get('/tsinghua/job', require('./routes/universities/tsinghua/job'));

// 中国人民大学
router.get('/rcu/job', require('./routes/universities/rcu/job'));

// 上海财经大学
router.get('/sufe/zpxx/:currentPageno', require('./routes/universities/sufe/zpxx'));

// 北京大学
router.get('/pku/eecs/:type?', require('./routes/universities/pku/eecs'));
router.get('/pku/job/:category?', require('./routes/universities/pku/job'));
...
router.get('/buaa/job/:type?', require('./routes/universities/buaa/job'));
...
// RSSjob
router.get('/00RSSjob_xjc/zhihu_social', require('./routes/00RSSjob_xjc/zhihu_social'));
router.get('/00RSSjob_xjc/zhihu_campus', require('./routes/00RSSjob_xjc/zhihu_campus'));
router.get('/00RSSjob_xjc/huanjushidai_social', require('./routes/00RSSjob_xjc/huanjushidai_social'));
router.get('/00RSSjob_xjc/huanjushidai_campus', require('./routes/00RSSjob_xjc/huanjushidai_campus'));
router.get('/00RSSjob_xjc/qingtingfm_social', require('./routes/00RSSjob_xjc/qingtingfm_social'));
router.get('/00RSSjob_xjc/qingtingfm_campus', require('./routes/00RSSjob_xjc/qingtingfm_campus'));
router.get('/00RSSjob_xjc/shengqu_social', require('./routes/00RSSjob_xjc/shengqu_social'));
router.get('/00RSSjob_xjc/shengqu_campus', require('./routes/00RSSjob_xjc/shengqu_campus'));
router.get('/00RSSjob_xjc/4paradigm_social', require('./routes/00RSSjob_xjc/4paradigm_social'));
router.get('/00RSSjob_xjc/4paradigm_campus', require('./routes/00RSSjob_xjc/4paradigm_campus'));
router.get('/00RSSjob_xjc/asiainnovations_social', require('./routes/00RSSjob_xjc/asiainnovations_social'));
router.get('/00RSSjob_xjc/asiainnovations_campus', require('./routes/00RSSjob_xjc/asiainnovations_campus'));
router.get('/00RSSjob_xjc/bilibili_social', require('./routes/00RSSjob_xjc/bilibili_social'));
router.get('/00RSSjob_xjc/bilibili_campus', require('./routes/00RSSjob_xjc/bilibili_campus'));
router.get('/00RSSjob_xjc/growingio_social', require('./routes/00RSSjob_xjc/growingio_social'));
router.get('/00RSSjob_xjc/growingio_campus', require('./routes/00RSSjob_xjc/growingio_campus'));
router.get('/00RSSjob_xjc/hujiang_social', require('./routes/00RSSjob_xjc/hujiang_social'));
router.get('/00RSSjob_xjc/hujiang_campus', require('./routes/00RSSjob_xjc/hujiang_campus'));
router.get('/00RSSjob_xjc/youxinjinfu_social', require('./routes/00RSSjob_xjc/youxinjinfu_social'));
router.get('/00RSSjob_xjc/youxinjinfu_campus', require('./routes/00RSSjob_xjc/youxinjinfu_campus'));
router.get('/00RSSjob_xjc/xiaomi_social', require('./routes/00RSSjob_xjc/xiaomi_social'));
router.get('/00RSSjob_xjc/xiaomi_campus1', require('./routes/00RSSjob_xjc/xiaomi_campus1'));
router.get('/00RSSjob_xjc/xiaomi_campus2', require('./routes/00RSSjob_xjc/xiaomi_campus2'));
router.get('/00RSSjob_xjc/xiaomi_campus3', require('./routes/00RSSjob_xjc/xiaomi_campus3'));
router.get('/00RSSjob_xjc/xiaomi_campus4', require('./routes/00RSSjob_xjc/xiaomi_campus4'));
router.get('/00RSSjob_xjc/bigo_social', require('./routes/00RSSjob_xjc/bigo_social'));
router.get('/00RSSjob_xjc/bigo_campus', require('./routes/00RSSjob_xjc/bigo_campus'));
router.get('/00RSSjob_xjc/ddi_social', require('./routes/00RSSjob_xjc/ddi_social'));
router.get('/00RSSjob_xjc/ddi_campus', require('./routes/00RSSjob_xjc/ddi_campus'));
router.get('/00RSSjob_xjc/duxiaoman_social', require('./routes/00RSSjob_xjc/duxiaoman_social'));
router.get('/00RSSjob_xjc/duxiaoman_campus', require('./routes/00RSSjob_xjc/duxiaoman_campus'));
router.get('/00RSSjob_xjc/fenbi_social', require('./routes/00RSSjob_xjc/fenbi_social'));
router.get('/00RSSjob_xjc/fenbi_campus', require('./routes/00RSSjob_xjc/fenbi_campus'));
router.get('/00RSSjob_xjc/gaodun_social', require('./routes/00RSSjob_xjc/gaodun_social'));
router.get('/00RSSjob_xjc/gaodun_campus', require('./routes/00RSSjob_xjc/gaodun_campus'));
router.get('/00RSSjob_xjc/liulishuo_social', require('./routes/00RSSjob_xjc/liulishuo_social'));
router.get('/00RSSjob_xjc/liulishuo_campus', require('./routes/00RSSjob_xjc/liulishuo_campus'));
router.get('/00RSSjob_xjc/missfresh_social', require('./routes/00RSSjob_xjc/missfresh_social'));
router.get('/00RSSjob_xjc/missfresh_campus', require('./routes/00RSSjob_xjc/missfresh_campus'));
router.get('/00RSSjob_xjc/morningstar_social', require('./routes/00RSSjob_xjc/morningstar_social'));
router.get('/00RSSjob_xjc/morningstar_campus', require('./routes/00RSSjob_xjc/morningstar_campus'));
router.get('/00RSSjob_xjc/mydreamplus_social', require('./routes/00RSSjob_xjc/mydreamplus_social'));
router.get('/00RSSjob_xjc/mydreamplus_campus', require('./routes/00RSSjob_xjc/mydreamplus_campus'));
router.get('/00RSSjob_xjc/rongzi_social', require('./routes/00RSSjob_xjc/rongzi_social'));
router.get('/00RSSjob_xjc/rongzi_campus', require('./routes/00RSSjob_xjc/rongzi_campus'));
router.get('/00RSSjob_xjc/shein_social', require('./routes/00RSSjob_xjc/shein_social'));
router.get('/00RSSjob_xjc/shein_campus', require('./routes/00RSSjob_xjc/shein_campus'));
router.get('/00RSSjob_xjc/venustech_social', require('./routes/00RSSjob_xjc/venustech_social'));
router.get('/00RSSjob_xjc/venustech_campus', require('./routes/00RSSjob_xjc/venustech_campus'));
router.get('/00RSSjob_xjc/yitu-inc_social', require('./routes/00RSSjob_xjc/yitu-inc_social'));
router.get('/00RSSjob_xjc/yitu-inc_campus', require('./routes/00RSSjob_xjc/yitu-inc_campus'));
router.get('/00RSSjob_xjc/3songshu_social', require('./routes/00RSSjob_xjc/3songshu_social'));
router.get('/00RSSjob_xjc/3songshu_campus', require('./routes/00RSSjob_xjc/3songshu_campus'));
router.get('/00RSSjob_xjc/armchina_social', require('./routes/00RSSjob_xjc/armchina_social'));
router.get('/00RSSjob_xjc/armchina_campus', require('./routes/00RSSjob_xjc/armchina_campus'));
router.get('/00RSSjob_xjc/baicizhan_social', require('./routes/00RSSjob_xjc/baicizhan_social'));
router.get('/00RSSjob_xjc/baicizhan_campus', require('./routes/00RSSjob_xjc/baicizhan_campus'));
router.get('/00RSSjob_xjc/freshhema_social', require('./routes/00RSSjob_xjc/freshhema_social'));
router.get('/00RSSjob_xjc/freshhema_campus', require('./routes/00RSSjob_xjc/freshhema_campus'));
router.get('/00RSSjob_xjc/futu5_social', require('./routes/00RSSjob_xjc/futu5_social'));
router.get('/00RSSjob_xjc/futu5_campus', require('./routes/00RSSjob_xjc/futu5_campus'));
router.get('/00RSSjob_xjc/guanghe_social', require('./routes/00RSSjob_xjc/guanghe_social'));
router.get('/00RSSjob_xjc/guanghe_campus', require('./routes/00RSSjob_xjc/guanghe_campus'));
router.get('/00RSSjob_xjc/immomo_social', require('./routes/00RSSjob_xjc/immomo_social'));
router.get('/00RSSjob_xjc/immomo_campus', require('./routes/00RSSjob_xjc/immomo_campus'));
router.get('/00RSSjob_xjc/kingsoft_social', require('./routes/00RSSjob_xjc/kingsoft_social'));
router.get('/00RSSjob_xjc/kingsoft_campus', require('./routes/00RSSjob_xjc/kingsoft_campus'));
router.get('/00RSSjob_xjc/moka_social', require('./routes/00RSSjob_xjc/moka_social'));
router.get('/00RSSjob_xjc/moka_campus', require('./routes/00RSSjob_xjc/moka_campus'));
router.get('/00RSSjob_xjc/msxf_social', require('./routes/00RSSjob_xjc/msxf_social'));
router.get('/00RSSjob_xjc/msxf_campus', require('./routes/00RSSjob_xjc/msxf_campus'));
router.get('/00RSSjob_xjc/tigerbrokers_social', require('./routes/00RSSjob_xjc/tigerbrokers_social'));
router.get('/00RSSjob_xjc/tigerbrokers_campus', require('./routes/00RSSjob_xjc/tigerbrokers_campus'));
router.get('/00RSSjob_xjc/transwarp_social', require('./routes/00RSSjob_xjc/transwarp_social'));
router.get('/00RSSjob_xjc/transwarp_campus', require('./routes/00RSSjob_xjc/transwarp_campus'));
router.get('/00RSSjob_xjc/tusenweilai_social', require('./routes/00RSSjob_xjc/tusenweilai_social'));
router.get('/00RSSjob_xjc/tusenweilai_campus', require('./routes/00RSSjob_xjc/tusenweilai_campus'));
router.get('/00RSSjob_xjc/wecash_social', require('./routes/00RSSjob_xjc/wecash_social'));
router.get('/00RSSjob_xjc/wecash_campus', require('./routes/00RSSjob_xjc/wecash_campus'));
router.get('/00RSSjob_xjc/wps_social', require('./routes/00RSSjob_xjc/wps_social'));
router.get('/00RSSjob_xjc/wps_campus', require('./routes/00RSSjob_xjc/wps_campus'));
router.get('/00RSSjob_xjc/xiaopeng_social1', require('./routes/00RSSjob_xjc/xiaopeng_social1'));
router.get('/00RSSjob_xjc/xiaopeng_social2', require('./routes/00RSSjob_xjc/xiaopeng_social2'));
router.get('/00RSSjob_xjc/xiaopeng_campus', require('./routes/00RSSjob_xjc/xiaopeng_campus'));
router.get('/00RSSjob_xjc/xueqiu_social', require('./routes/00RSSjob_xjc/xueqiu_social'));
router.get('/00RSSjob_xjc/xueqiu_campus', require('./routes/00RSSjob_xjc/xueqiu_campus'));
router.get('/00RSSjob_xjc/zhongan_social', require('./routes/00RSSjob_xjc/zhongan_social'));
router.get('/00RSSjob_xjc/zhongan_campus', require('./routes/00RSSjob_xjc/zhongan_campus'));
router.get('/00RSSjob_xjc/360jinrong_social', require('./routes/00RSSjob_xjc/360jinrong_social'));
router.get('/00RSSjob_xjc/360jinrong_campus', require('./routes/00RSSjob_xjc/360jinrong_campus'));
router.get('/00RSSjob_xjc/benmu-health_social', require('./routes/00RSSjob_xjc/benmu-health_social'));
router.get('/00RSSjob_xjc/benmu-health_campus', require('./routes/00RSSjob_xjc/benmu-health_campus'));
router.get('/00RSSjob_xjc/chenxing_social', require('./routes/00RSSjob_xjc/chenxing_social'));
router.get('/00RSSjob_xjc/chenxing_campus', require('./routes/00RSSjob_xjc/chenxing_campus'));
router.get('/00RSSjob_xjc/danielwellington_social', require('./routes/00RSSjob_xjc/danielwellington_social'));
router.get('/00RSSjob_xjc/danielwellington_campus', require('./routes/00RSSjob_xjc/danielwellington_campus'));
router.get('/00RSSjob_xjc/fun_social', require('./routes/00RSSjob_xjc/fun_social'));
router.get('/00RSSjob_xjc/fun_campus', require('./routes/00RSSjob_xjc/fun_campus'));
router.get('/00RSSjob_xjc/gaosiedu_social', require('./routes/00RSSjob_xjc/gaosiedu_social'));
router.get('/00RSSjob_xjc/gaosiedu_campus', require('./routes/00RSSjob_xjc/gaosiedu_campus'));
router.get('/00RSSjob_xjc/inceptio-ai_social', require('./routes/00RSSjob_xjc/inceptio-ai_social'));
router.get('/00RSSjob_xjc/inceptio-ai_campus', require('./routes/00RSSjob_xjc/inceptio-ai_campus'));
router.get('/00RSSjob_xjc/infervision_social', require('./routes/00RSSjob_xjc/infervision_social'));
router.get('/00RSSjob_xjc/infervision_campus', require('./routes/00RSSjob_xjc/infervision_campus'));
router.get('/00RSSjob_xjc/jodoinc_social', require('./routes/00RSSjob_xjc/jodoinc_social'));
router.get('/00RSSjob_xjc/jodoinc_campus', require('./routes/00RSSjob_xjc/jodoinc_campus'));
router.get('/00RSSjob_xjc/knowbox_social', require('./routes/00RSSjob_xjc/knowbox_social'));
router.get('/00RSSjob_xjc/knowbox_campus', require('./routes/00RSSjob_xjc/knowbox_campus'));
router.get('/00RSSjob_xjc/malong_social', require('./routes/00RSSjob_xjc/malong_social'));
router.get('/00RSSjob_xjc/malong_campus', require('./routes/00RSSjob_xjc/malong_campus'));
router.get('/00RSSjob_xjc/paipaidai_social', require('./routes/00RSSjob_xjc/paipaidai_social'));
router.get('/00RSSjob_xjc/paipaidai_campus', require('./routes/00RSSjob_xjc/paipaidai_campus'));
router.get('/00RSSjob_xjc/qianxun_social', require('./routes/00RSSjob_xjc/qianxun_social'));
router.get('/00RSSjob_xjc/qianxun_campus', require('./routes/00RSSjob_xjc/qianxun_campus'));
router.get('/00RSSjob_xjc/qudian_social', require('./routes/00RSSjob_xjc/qudian_social'));
router.get('/00RSSjob_xjc/qudian_campus', require('./routes/00RSSjob_xjc/qudian_campus'));
router.get('/00RSSjob_xjc/relxtech_social', require('./routes/00RSSjob_xjc/relxtech_social'));
router.get('/00RSSjob_xjc/relxtech_campus', require('./routes/00RSSjob_xjc/relxtech_campus'));
router.get('/00RSSjob_xjc/shopee_social', require('./routes/00RSSjob_xjc/shopee_social'));
router.get('/00RSSjob_xjc/shopee_campus', require('./routes/00RSSjob_xjc/shopee_campus'));
router.get('/00RSSjob_xjc/sugon_social', require('./routes/00RSSjob_xjc/sugon_social'));
router.get('/00RSSjob_xjc/sugon_campus', require('./routes/00RSSjob_xjc/sugon_campus'));
router.get('/00RSSjob_xjc/xdf_social', require('./routes/00RSSjob_xjc/xdf_social'));
router.get('/00RSSjob_xjc/xdf_campus', require('./routes/00RSSjob_xjc/xdf_campus'));
router.get('/00RSSjob_xjc/aibee_social', require('./routes/00RSSjob_xjc/aibee_social'));
router.get('/00RSSjob_xjc/aibee_campus', require('./routes/00RSSjob_xjc/aibee_campus'));
router.get('/00RSSjob_xjc/cootek_social', require('./routes/00RSSjob_xjc/cootek_social'));
router.get('/00RSSjob_xjc/cootek_campus', require('./routes/00RSSjob_xjc/cootek_campus'));
router.get('/00RSSjob_xjc/esquel_social', require('./routes/00RSSjob_xjc/esquel_social'));
router.get('/00RSSjob_xjc/esquel_campus', require('./routes/00RSSjob_xjc/esquel_campus'));
router.get('/00RSSjob_xjc/feiyu_social', require('./routes/00RSSjob_xjc/feiyu_social'));
router.get('/00RSSjob_xjc/feiyu_campus', require('./routes/00RSSjob_xjc/feiyu_campus'));
router.get('/00RSSjob_xjc/ict_social', require('./routes/00RSSjob_xjc/ict_social'));
router.get('/00RSSjob_xjc/ict_campus1', require('./routes/00RSSjob_xjc/ict_campus1'));
router.get('/00RSSjob_xjc/ict_campus2', require('./routes/00RSSjob_xjc/ict_campus2'));
router.get('/00RSSjob_xjc/ict_campus3', require('./routes/00RSSjob_xjc/ict_campus3'));
router.get('/00RSSjob_xjc/ihandysoft_social', require('./routes/00RSSjob_xjc/ihandysoft_social'));
router.get('/00RSSjob_xjc/ihandysoft_campus', require('./routes/00RSSjob_xjc/ihandysoft_campus'));
router.get('/00RSSjob_xjc/jingchi_social', require('./routes/00RSSjob_xjc/jingchi_social'));
router.get('/00RSSjob_xjc/jingchi_campus', require('./routes/00RSSjob_xjc/jingchi_campus'));
router.get('/00RSSjob_xjc/k11_social', require('./routes/00RSSjob_xjc/k11_social'));
router.get('/00RSSjob_xjc/k11_campus', require('./routes/00RSSjob_xjc/k11_campus'));
router.get('/00RSSjob_xjc/leyuansu_social', require('./routes/00RSSjob_xjc/leyuansu_social'));
router.get('/00RSSjob_xjc/leyuansu_campus', require('./routes/00RSSjob_xjc/leyuansu_campus'));
router.get('/00RSSjob_xjc/lianluo_social', require('./routes/00RSSjob_xjc/lianluo_social'));
router.get('/00RSSjob_xjc/lianluo_campus', require('./routes/00RSSjob_xjc/lianluo_campus'));
router.get('/00RSSjob_xjc/mafengwo1_social', require('./routes/00RSSjob_xjc/mafengwo1_social'));
router.get('/00RSSjob_xjc/mafengwo1_campus', require('./routes/00RSSjob_xjc/mafengwo1_campus'));
router.get('/00RSSjob_xjc/maoyan_social', require('./routes/00RSSjob_xjc/maoyan_social'));
router.get('/00RSSjob_xjc/maoyan_campus', require('./routes/00RSSjob_xjc/maoyan_campus'));
router.get('/00RSSjob_xjc/pony_social', require('./routes/00RSSjob_xjc/pony_social'));
router.get('/00RSSjob_xjc/pony_campus', require('./routes/00RSSjob_xjc/pony_campus'));
router.get('/00RSSjob_xjc/qunhemail_social', require('./routes/00RSSjob_xjc/qunhemail_social'));
router.get('/00RSSjob_xjc/qunhemail_campus', require('./routes/00RSSjob_xjc/qunhemail_campus'));
router.get('/00RSSjob_xjc/souche_social', require('./routes/00RSSjob_xjc/souche_social'));
router.get('/00RSSjob_xjc/souche_campus', require('./routes/00RSSjob_xjc/souche_campus'));
router.get('/00RSSjob_xjc/xinshixiang_social', require('./routes/00RSSjob_xjc/xinshixiang_social'));
router.get('/00RSSjob_xjc/xinshixiang_campus', require('./routes/00RSSjob_xjc/xinshixiang_campus'));
router.get('/00RSSjob_xjc/yicai_social', require('./routes/00RSSjob_xjc/yicai_social'));
router.get('/00RSSjob_xjc/yicai_campus', require('./routes/00RSSjob_xjc/yicai_campus'));
router.get('/00RSSjob_xjc/17zuoye_social', require('./routes/00RSSjob_xjc/17zuoye_social'));
router.get('/00RSSjob_xjc/17zuoye_campus', require('./routes/00RSSjob_xjc/17zuoye_campus'));
router.get('/00RSSjob_xjc/baixing_social', require('./routes/00RSSjob_xjc/baixing_social'));
router.get('/00RSSjob_xjc/baixing_campus', require('./routes/00RSSjob_xjc/baixing_campus'));
router.get('/00RSSjob_xjc/cloudminds_social', require('./routes/00RSSjob_xjc/cloudminds_social'));
router.get('/00RSSjob_xjc/cloudminds_campus', require('./routes/00RSSjob_xjc/cloudminds_campus'));
router.get('/00RSSjob_xjc/ebupt_social', require('./routes/00RSSjob_xjc/ebupt_social'));
router.get('/00RSSjob_xjc/ebupt_campus', require('./routes/00RSSjob_xjc/ebupt_campus'));
router.get('/00RSSjob_xjc/hellobike_social', require('./routes/00RSSjob_xjc/hellobike_social'));
router.get('/00RSSjob_xjc/hellobike_campus', require('./routes/00RSSjob_xjc/hellobike_campus'));
router.get('/00RSSjob_xjc/huike_social', require('./routes/00RSSjob_xjc/huike_social'));
router.get('/00RSSjob_xjc/huike_campus', require('./routes/00RSSjob_xjc/huike_campus'));
router.get('/00RSSjob_xjc/kikatech_social', require('./routes/00RSSjob_xjc/kikatech_social'));
router.get('/00RSSjob_xjc/kikatech_campus', require('./routes/00RSSjob_xjc/kikatech_campus'));
router.get('/00RSSjob_xjc/pconline_social', require('./routes/00RSSjob_xjc/pconline_social'));
router.get('/00RSSjob_xjc/pconline_campus', require('./routes/00RSSjob_xjc/pconline_campus'));
router.get('/00RSSjob_xjc/phoenixcontact_social', require('./routes/00RSSjob_xjc/phoenixcontact_social'));
router.get('/00RSSjob_xjc/phoenixcontact_campus', require('./routes/00RSSjob_xjc/phoenixcontact_campus'));
router.get('/00RSSjob_xjc/pinsmedical_social', require('./routes/00RSSjob_xjc/pinsmedical_social'));
router.get('/00RSSjob_xjc/pinsmedical_campus', require('./routes/00RSSjob_xjc/pinsmedical_campus'));
router.get('/00RSSjob_xjc/sensorsdata_social', require('./routes/00RSSjob_xjc/sensorsdata_social'));
router.get('/00RSSjob_xjc/sensorsdata_campus', require('./routes/00RSSjob_xjc/sensorsdata_campus'));
router.get('/00RSSjob_xjc/sogou-inc_social', require('./routes/00RSSjob_xjc/sogou-inc_social'));
router.get('/00RSSjob_xjc/sogou-inc_campus', require('./routes/00RSSjob_xjc/sogou-inc_campus'));
router.get('/00RSSjob_xjc/teamsun_social', require('./routes/00RSSjob_xjc/teamsun_social'));
router.get('/00RSSjob_xjc/teamsun_campus', require('./routes/00RSSjob_xjc/teamsun_campus'));
router.get('/00RSSjob_xjc/wayyue_social', require('./routes/00RSSjob_xjc/wayyue_social'));
router.get('/00RSSjob_xjc/wayyue_campus', require('./routes/00RSSjob_xjc/wayyue_campus'));
router.get('/00RSSjob_xjc/xiangwushuo_social', require('./routes/00RSSjob_xjc/xiangwushuo_social'));
router.get('/00RSSjob_xjc/xiangwushuo_campus', require('./routes/00RSSjob_xjc/xiangwushuo_campus'));
router.get('/00RSSjob_xjc/yiche_social', require('./routes/00RSSjob_xjc/yiche_social'));
router.get('/00RSSjob_xjc/yiche_campus', require('./routes/00RSSjob_xjc/yiche_campus'));
router.get('/00RSSjob_xjc/ainirobot_social', require('./routes/00RSSjob_xjc/ainirobot_social'));
router.get('/00RSSjob_xjc/ainirobot_campus', require('./routes/00RSSjob_xjc/ainirobot_campus'));
router.get('/00RSSjob_xjc/allinpay_social', require('./routes/00RSSjob_xjc/allinpay_social'));
router.get('/00RSSjob_xjc/allinpay_campus', require('./routes/00RSSjob_xjc/allinpay_campus'));
router.get('/00RSSjob_xjc/bitmain_social', require('./routes/00RSSjob_xjc/bitmain_social'));
router.get('/00RSSjob_xjc/bitmain_campus', require('./routes/00RSSjob_xjc/bitmain_campus'));
router.get('/00RSSjob_xjc/chengyingshuju_social', require('./routes/00RSSjob_xjc/chengyingshuju_social'));
router.get('/00RSSjob_xjc/chengyingshuju_campus', require('./routes/00RSSjob_xjc/chengyingshuju_campus'));
router.get('/00RSSjob_xjc/cibfintech_social', require('./routes/00RSSjob_xjc/cibfintech_social'));
router.get('/00RSSjob_xjc/cibfintech_campus', require('./routes/00RSSjob_xjc/cibfintech_campus'));
router.get('/00RSSjob_xjc/clobotics_social', require('./routes/00RSSjob_xjc/clobotics_social'));
router.get('/00RSSjob_xjc/clobotics_campus', require('./routes/00RSSjob_xjc/clobotics_campus'));
router.get('/00RSSjob_xjc/dhgate_social', require('./routes/00RSSjob_xjc/dhgate_social'));
router.get('/00RSSjob_xjc/dhgate_campus', require('./routes/00RSSjob_xjc/dhgate_campus'));
router.get('/00RSSjob_xjc/enn_social', require('./routes/00RSSjob_xjc/enn_social'));
router.get('/00RSSjob_xjc/enn_campus', require('./routes/00RSSjob_xjc/enn_campus'));
router.get('/00RSSjob_xjc/fapon_social', require('./routes/00RSSjob_xjc/fapon_social'));
router.get('/00RSSjob_xjc/fapon_campus', require('./routes/00RSSjob_xjc/fapon_campus'));
router.get('/00RSSjob_xjc/idgcapital_social', require('./routes/00RSSjob_xjc/idgcapital_social'));
router.get('/00RSSjob_xjc/idgcapital_campus', require('./routes/00RSSjob_xjc/idgcapital_campus'));
router.get('/00RSSjob_xjc/lianjia_social', require('./routes/00RSSjob_xjc/lianjia_social'));
router.get('/00RSSjob_xjc/lianjia_campus', require('./routes/00RSSjob_xjc/lianjia_campus'));
router.get('/00RSSjob_xjc/nullmax_social', require('./routes/00RSSjob_xjc/nullmax_social'));
router.get('/00RSSjob_xjc/nullmax_campus', require('./routes/00RSSjob_xjc/nullmax_campus'));
router.get('/00RSSjob_xjc/saicmobility_social', require('./routes/00RSSjob_xjc/saicmobility_social'));
router.get('/00RSSjob_xjc/saicmobility_campus', require('./routes/00RSSjob_xjc/saicmobility_campus'));
router.get('/00RSSjob_xjc/sequoiacap_social', require('./routes/00RSSjob_xjc/sequoiacap_social'));
router.get('/00RSSjob_xjc/sequoiacap_campus', require('./routes/00RSSjob_xjc/sequoiacap_campus'));
router.get('/00RSSjob_xjc/shimo_social', require('./routes/00RSSjob_xjc/shimo_social'));
router.get('/00RSSjob_xjc/shimo_campus', require('./routes/00RSSjob_xjc/shimo_campus'));
router.get('/00RSSjob_xjc/tantan_social', require('./routes/00RSSjob_xjc/tantan_social'));
router.get('/00RSSjob_xjc/tantan_campus', require('./routes/00RSSjob_xjc/tantan_campus'));
router.get('/00RSSjob_xjc/tezan_social', require('./routes/00RSSjob_xjc/tezan_social'));
router.get('/00RSSjob_xjc/tezan_campus', require('./routes/00RSSjob_xjc/tezan_campus'));
router.get('/00RSSjob_xjc/xiaozhan_social', require('./routes/00RSSjob_xjc/xiaozhan_social'));
router.get('/00RSSjob_xjc/xiaozhan_campus', require('./routes/00RSSjob_xjc/xiaozhan_campus'));
router.get('/00RSSjob_xjc/yinker_social', require('./routes/00RSSjob_xjc/yinker_social'));
router.get('/00RSSjob_xjc/yinker_campus', require('./routes/00RSSjob_xjc/yinker_campus'));
router.get('/00RSSjob_xjc/yirendai_social', require('./routes/00RSSjob_xjc/yirendai_social'));
router.get('/00RSSjob_xjc/yirendai_campus', require('./routes/00RSSjob_xjc/yirendai_campus'));
router.get('/00RSSjob_xjc/ymm56_social', require('./routes/00RSSjob_xjc/ymm56_social'));
router.get('/00RSSjob_xjc/ymm56_campus', require('./routes/00RSSjob_xjc/ymm56_campus'));
router.get('/00RSSjob_xjc/bestpay_social', require('./routes/00RSSjob_xjc/bestpay_social'));
router.get('/00RSSjob_xjc/bestpay_campus', require('./routes/00RSSjob_xjc/bestpay_campus'));
router.get('/00RSSjob_xjc/ethercap_social', require('./routes/00RSSjob_xjc/ethercap_social'));
router.get('/00RSSjob_xjc/ethercap_campus', require('./routes/00RSSjob_xjc/ethercap_campus'));
router.get('/00RSSjob_xjc/kedi_social', require('./routes/00RSSjob_xjc/kedi_social'));
router.get('/00RSSjob_xjc/kedi_campus', require('./routes/00RSSjob_xjc/kedi_campus'));
router.get('/00RSSjob_xjc/klook_social', require('./routes/00RSSjob_xjc/klook_social'));
router.get('/00RSSjob_xjc/klook_campus', require('./routes/00RSSjob_xjc/klook_campus'));
router.get('/00RSSjob_xjc/lizhifm_social', require('./routes/00RSSjob_xjc/lizhifm_social'));
router.get('/00RSSjob_xjc/lizhifm_campus', require('./routes/00RSSjob_xjc/lizhifm_campus'));
router.get('/00RSSjob_xjc/momenta_social', require('./routes/00RSSjob_xjc/momenta_social'));
router.get('/00RSSjob_xjc/momenta_campus', require('./routes/00RSSjob_xjc/momenta_campus'));
router.get('/00RSSjob_xjc/vipcode_social', require('./routes/00RSSjob_xjc/vipcode_social'));
router.get('/00RSSjob_xjc/vipcode_campus', require('./routes/00RSSjob_xjc/vipcode_campus'));
router.get('/00RSSjob_xjc/wallstreetcn_social', require('./routes/00RSSjob_xjc/wallstreetcn_social'));
router.get('/00RSSjob_xjc/wallstreetcn_campus', require('./routes/00RSSjob_xjc/wallstreetcn_campus'));
router.get('/00RSSjob_xjc/xingshulin_social', require('./routes/00RSSjob_xjc/xingshulin_social'));
router.get('/00RSSjob_xjc/xingshulin_campus', require('./routes/00RSSjob_xjc/xingshulin_campus'));
router.get('/00RSSjob_xjc/zhongke_social', require('./routes/00RSSjob_xjc/zhongke_social'));
router.get('/00RSSjob_xjc/zhongke_campus', require('./routes/00RSSjob_xjc/zhongke_campus'));
router.get('/00RSSjob_xjc/belle_social', require('./routes/00RSSjob_xjc/belle_social'));
router.get('/00RSSjob_xjc/belle_campus', require('./routes/00RSSjob_xjc/belle_campus'));
